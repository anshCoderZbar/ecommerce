        ...
        <div className="w-full md:w-2/4 mx-auto my-5">
          ...
          <div className="p-8 md:p-16 shadow-lg max-w-4xl mx-auto">
            ...
            <div className="flex items-center my-8">
              <hr className="flex-grow border-[#4a4848] border-t-[1px] mr-4" />
            ...
            <form>
              ...
              <input
                type="submit"
                value="Login"
                className="inline-block leading-none uppercase text-white text-sm bg-black px-5 py-4 transition-all hover:bg-red-500"
              />
            </form>
          </div>
        </div>
