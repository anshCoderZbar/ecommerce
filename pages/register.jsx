            ...
            <div className="p-8 md:p-16 shadow-lg  max-w-4xl mx-auto">
              ...
              <form noValidate onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                  type="submit"
                  value="Register"
                  className="inline-block leading-none uppercase cursor-pointer text-white text-sm bg-black px-5 py-4 transition-all hover:bg-red-500 dark:bg-red-900 dark:hover:bg-red-950"
                />
              </form>
            </div>
          </div>
