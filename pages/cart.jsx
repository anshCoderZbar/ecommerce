              ...
              <div className="w-full h-fit bg-white border shadow-lg">
                <div className="p-6 ">
                  <div className="flex">
                    ...
                    <div className="mt-3 pt-0 px-6 pb-6 min-h-[112px] max-w-[460px]">
                      <h2 className="text-base">Product Name</h2>
                      <span className="text-gray-500">Product min details</span>
                  ...
                  <div className="py-3 flex gap-5">
                    ...
                    <div className="flex gap-3">
                      <button className="text-base font-medium uppercase">
                        Save for later
                      </button>
                      <button className="text-base font-medium uppercase">
                        Remove
